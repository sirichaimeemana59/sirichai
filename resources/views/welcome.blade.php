    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav text-uppercase ml-auto">
                <li class="nav-item"><a class="nav-link js-scroll-trigger" data-toggle="modal" data-target="#myModal-Login" type="button">Login</a></li>
...
<header class="masthead">
    <div class="container">
        ...
        <button type="button" class="btn btn-warning btn-lg" data-toggle="modal" data-target="#myModal-Register">Register</button>
    </div>
</header>
